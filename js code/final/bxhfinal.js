...
let SHEET_TITLE = 'Chung kết';
let SHEET_RANGE_VONG_1 = 'B11:N18';
...
.then((rep) => {
  ...
  for (let i = 0; i < data.table.rows.length; i++) {
    ...
    cell0.textContent = rowData[0]?.v ?? null;
    cell1.textContent = rowData[1]?.v ?? null;
    cell2.textContent = rowData[2]?.v ?? null;
    cell3.textContent = rowData[3]?.v ?? null;
    cell4.textContent = rowData[4]?.v ?? null;
    cell5.textContent = rowData[5]?.v ?? null;
    cell6.textContent = rowData[6]?.v ?? null;
    cell7.textContent = rowData[7]?.v ?? null;
    cell8.textContent = rowData[8]?.v ?? null;
    cell9.textContent = rowData[9]?.v ?? null;
    cell10.textContent = rowData[10]?.v ?? null;
    cell11.textContent = rowData[11]?.v ?? null;
    cell12.textContent = rowData[12]?.v ?? null;
